<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <form action="" wire:submit.prevent="createExpense" class="w-full max-w-7xl mx-auto mt-10" enctype="multipart/form-data">
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <p class="w-full px-3 mb-6 md:mb-0 mt-3">
                ...
                @if($photo)
                    <figure class="sm:max-w-sm ">
                        <img class="h-auto mt-3 ml-3 max-w-full rounded-lg" src="{{$photo->temporaryUrl()}}" alt="image description">
            ...
            <p class="w-full px-3 mb-6 md:mb-0 mt-3">
                <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                    Data Comprovante, pode deixar em branco se o dia for hoje
                </label>
