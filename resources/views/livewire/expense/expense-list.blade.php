<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <div class="w-full mx-auto text-right mb-4 mt-10">
        <a href="{{route('expenses.create')}}" class="flex-shrink-0 bg-teal-500 hover:bg-teal-700 border-teal-500
        hover:border-teal-700 text-sm border-4 text-white py-2 px-6 rounded">Criar Registro</a>
    </div>
            ...
            <tr>
                ...
                <td class="px-4 py-4 border">
                    <a href="{{route('expenses.edit', $exp->id)}}"
                       class="px-4 py-2 border rounded bg-teal-700 text-white hover:bg-teal-300">
                        Editar
                    </a>
                    <a href="#" wire:click.prevent="remove({{$exp->id}})"
                    class="px-4 py-2 border rounded bg-red-700 hover:bg-red-600 text-white">
                        Remover
                    </a>
                </td>
            </tr>
